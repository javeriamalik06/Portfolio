...
# Javeria Malik - Data Analysis Portfolio
...
1. [A/B Testing for Marketing Ads](#ab-testing-ads)
...
12. [Maven Cycles Sales Dashboard](#maven-cycles-dashboard)
13. [FIFA World Cup PowerBi Dashboard](#fifa-dashboard)

---

## [A/B Testing for Marketing Ads](https://github.com/javeriamalik06/Marketing-AB-Testing/tree/main) <a name="ab-testing-ads"></a>
...
FIND THE INTERACTIVE DASHBOARD [HERE](https://project.novypro.com/xq4nsJ)
